...
// sequelize のデータベースの処理は基本的に全て、非同期 IO で実行する
//そのため前のデータベースの処理が前提となって次の処理を行いたい場合は、実行して得られる結果オブジェクトに対して、
// then 関数を呼び、そこに次に行いたい処理を記述する
...
// test/test.js 内でもこの関数を利用できるようにこの Router オブジェクトの公開関数にする
